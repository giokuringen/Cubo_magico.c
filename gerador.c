...
void salvar_arquivo(int cubo[6][3][3], const char *nome_arquivo) {
  ...
  if (!arquivo) { printf("Erro ao abrir o arquivo!"); 
    return; }
...
int main(int argc, char **argv) {
  ...
  // Aplicar rotação na face
 
  // Com x = 1, 2,3 
  // Mudar linha 0 das faces 1, 2, 3, 4
  //cubo[1][0][x] ->  cubo[2][0][x]
  //cubo[2][0][x] ->  cubo[3][0][x]
  //cubo[3][0][x] ->  cubo[4][0][x]
  //cubo[4][0][x] ->  cubo[1][0][x]
